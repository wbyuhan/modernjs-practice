...
function Option(props, ref) {
    ...
    var isChecked = isMultipleMode
        ...
        : valueSelect === value;
    var optionProps = __assign({ ref: ref, style: style, className: cs(prefixCls + "-option", (_a = {},
    ...
    if (isMultipleMode) {
        return (React.createElement("li", { className: cs(prefixCls + "-option-wrapper", (_b = {},
                _b[prefixCls + "-option-wrapper-selected"] = isChecked,
                _b[prefixCls + "-option-wrapper-disabled"] = disabled,
                _b), wrapperClassName) },
            React.createElement(Checkbox, { className: prefixCls + "-checkbox", checked: isChecked, disabled: disabled, onChange: optionProps.onClick }),
            React.createElement("span", __assign({}, optionProps), children)));
    }
    return React.createElement("li", __assign({}, optionProps), children);
}
