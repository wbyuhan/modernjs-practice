...
var defaultProps = {
    animation: true,
    validate: function (inputValue, values) { return inputValue && values.every(function (item) { return item !== inputValue; }); },
};
function InputTag(baseProps, ref) {
    ...
    var UsedTransitionGroup = (0, react_1.useMemo)(function () { return function (_a) {
    ...
    var valueChangeHandler = function (value) {
        ...
        onChange && onChange(labelInValue ? value : value.map(function (x) { return x.value; }));
    };
    var tagCloseHandler = function (itemValue, index, event) {
        onRemove && onRemove(itemValue, index, event);
        valueChangeHandler(__spreadArray(__spreadArray([], __read(value.slice(0, index)), false), __read(value.slice(index + 1)), false));
    };
    ...
    var mergedRenderTag = function (item, index) {
        ...
        return (react_1.default.createElement(Tag_1.default, { visible: true, className: (0, classNames_1.default)(prefixCls + "-tag", (_a = {},
            ...
            react_1.default.createElement("span", { title: typeof label === 'string' ? label : undefined, className: prefixCls + "-tag-content" }, typeof label === 'string' ? label.replace(/\s/g, '\u00A0') : label)));
    };
    var clearIcon = allowClear && !disabled && value.length ? (react_1.default.createElement(icon_hover_1.default, { size: size, key: "clearIcon", className: prefixCls + "-clear-icon", onClick: function (e) {
            e.stopPropagation();
            valueChangeHandler([]);
            if (!focused) {
            ...
            onClear && onClear();
        }, onMouseDown: keepFocus }, (icon && icon.clearIcon) || react_1.default.createElement(IconClose_1.default, null))) : null;
    var hasSuffix = !!(clearIcon || suffix);
    return (react_1.default.createElement("div", __assign({}, (0, constant_1.pickTriggerPropsFromRest)(props), { style: style, className: (0, classNames_1.default)(prefixCls, (_a = {},
            ...
            _a), className), onMouseDown: keepFocus, onClick: function (e) {
        ...
        react_1.default.createElement("div", { className: prefixCls + "-view" },
            react_1.default.createElement(UsedTransitionGroup, null,
                ...
                react_1.default.createElement(react_transition_group_1.CSSTransition, { key: "input", timeout: CSS_TRANSITION_DURATION, classNames: "zoomIn" },
                    react_1.default.createElement(input_element_1.default, { size: size, disabled: disabled || disableInput, readOnly: readOnly, ref: inputRef, autoFocus: autoFocus, placeholder: !value.length ? placeholder : '', prefixCls: prefixCls + "-input", autoFitWidth: {
                            ...
                            setInputValue('');
                            onBlur && onBlur(e);
                        }, value: inputValue, onValueChange: function (v, e) {
                            setInputValue(v);
