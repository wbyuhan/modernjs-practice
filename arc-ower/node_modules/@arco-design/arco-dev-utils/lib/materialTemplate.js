...
const ARCO_PACKAGE_INFO_MAP = {
    [constant_1.PACKAGE_NAME_ARCO_WEB_REACT_V2]: {
        name: constant_1.PACKAGE_NAME_ARCO_WEB_REACT_V2,
        version: '2.0.0',
        distCssName: 'arco.css',
    },
    [constant_1.PACKAGE_NAME_ARCO_WEB_VUE_V2]: {
 ...
 */
const addArcoDependency = (packageJson, arcoInfo, isForMonorepo = false) => {
 ...
 */
const removeArcoDependency = (packageJson, arcoPackageName) => {
    if (!arcoPackageName) {
        return;
    }
...
const transformToProject = ({ root, arcoPackageName, isForMonorepo, packageJson: packageJsonToExtend, }) => __awaiter(void 0, void 0, void 0, function* () {
...
const transformToTemplate = ({ root }) => __awaiter(void 0, void 0, void 0, function* () {
    const packageJson = fs_extra_1.default.readJsonSync('./package.json');
    const arcoPackageName = Object.keys(packageJson.peerDependencies || {}).find((name) => Object.keys(ARCO_PACKAGE_INFO_MAP).indexOf(name) > -1);
    // Handle package.json
    ...
    if (fs_extra_1.default.existsSync('.git')) {
        yield new Promise((resolve, reject) => {
            (0, cross_spawn_1.default)('git', ['clean', '-Xdf'], { stdio: 'ignore' }).on('close', (code) => {
    ...
    yield new Promise((resolve, reject) => {
        gulp_1.default
            ...
            .pipe((0, gulp_if_1.default)(!!arcoPackageInfo, (0, gulp_replace_1.default)(new RegExp(`${arcoPackageName}(/dist/css/)${arcoPackageInfo === null || arcoPackageInfo === void 0 ? void 0 : arcoPackageInfo.distCssName}`), (_, $1) => `${PLACEHOLDER_ARCO_PACKAGE_NAME}${$1}${PLACEHOLDER_ARCO_CSS_NAME}`)))
            .pipe((0, gulp_if_1.default)(!!arcoPackageInfo, (0, gulp_replace_1.default)(arcoPackageName, PLACEHOLDER_ARCO_PACKAGE_NAME)))
            .pipe(gulp_1.default.dest(root))
            .on('end', resolve)
            .on('error', reject);
    });
