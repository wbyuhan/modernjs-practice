...
var VirtualList = react_1.default.forwardRef(function (props, ref) {
    ...
    var _f = __read((0, react_1.useState)(200), 2), stateHeight = _f[0], setStateHeight = _f[1];
    ...
    var _g = __read((0, useStateWithPromise_1.default)({
        // measure status
        status: 'NONE',
        // render range info
        startIndex: 0,
                    ...
                    if (ele &&
                        ...
                        if (isStaticItemHeight) {
                            heightMap[KEY_VIRTUAL_ITEM_HEIGHT] =
                                heightMap[KEY_VIRTUAL_ITEM_HEIGHT] || (0, itemUtil_1.getNodeHeight)(ele);
                            heightMap[key] = heightMap[KEY_VIRTUAL_ITEM_HEIGHT];
                        }
                        else {
                            heightMap[key] = (0, itemUtil_1.getNodeHeight)(ele);
                        }
                    }
                },
            });
    ...
    return (react_1.default.createElement(resizeObserver_1.default, { onResize: function () {
            if (!(0, is_1.isNumber)(styleListMaxHeight)) {
                var clientHeight = refList.current.clientHeight;
        ...
        react_1.default.createElement(WrapperTagName, __assign({ ref: refList, style: __assign(__assign({ overflowY: 'auto', overflowAnchor: 'none' }, style), { maxHeight: styleListMaxHeight }), className: className, onScroll: isVirtual ? virtualListScrollHandler : rawListScrollHandler }, restProps), isVirtual ? (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(Filler_1.default, { height: itemTotalHeight, offset: state.status === 'MEASURE_DONE' ? state.startItemTop : 0 }, renderChildren(data.slice(state.startIndex, state.endIndex + 1), state.startIndex)),
            renderLongestItem())) : (react_1.default.createElement(Filler_1.default, { height: viewportHeight }, renderChildren(data, 0))))));
});
