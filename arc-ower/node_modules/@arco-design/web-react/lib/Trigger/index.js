...
var Trigger = /** @class */ (function (_super) {
    ...
    function Trigger(props, context) {
        ...
        _this.offWindowResize = function () {
            ...
            (0, dom_1.off)(window, 'resize', _this.handleContainerResize);
        };
        ...
        _this.handleContainerResize = (0, throttleByRaf_1.default)(function () {
        ...
        _this.isClickToHide = function () {
            return _this.isClickTrigger() && _this.getMergedProps().clickToClose;
        };
        ...
        _this.getTransformOrigin = function (position) {
            var _a, _b;
            var content = (0, react_dom_1.findDOMNode)(_this.triggerRef);
            if (!content)
                return {};
        ...
        _this.getPopupStyle = function () {
            ...
            var content = (0, react_dom_1.findDOMNode)(_this.triggerRef);
            var child = (0, react_dom_1.findDOMNode)(_this);
        ...
        _this.onClickOutside = function (e) {
            ...
            var triggerNode = (0, react_dom_1.findDOMNode)(_this.triggerRef);
            var childrenDom = (0, react_dom_1.findDOMNode)(_this);
    ...
    Trigger.prototype.componentDidMount = function () {
        ...
        this.childrenDom = (0, react_dom_1.findDOMNode)(this);
    ...
    Trigger.prototype.componentDidUpdate = function (_prevProps) {
        ...
        if (!this.handleWindowResize) {
            (0, dom_1.on)(window, 'resize', this.handleContainerResize);
    ...
    Trigger.prototype.render = function () {
        var _a, _b;
        var _this = this;
        var _c = this.getMergedProps(), children = _c.children, style = _c.style, className = _c.className, arrowProps = _c.arrowProps, disabled = _c.disabled, popup = _c.popup, classNames = _c.classNames, duration = _c.duration, unmountOnExit = _c.unmountOnExit, alignPoint = _c.alignPoint, position = _c.position, childrenPrefix = _c.childrenPrefix, showArrow = _c.showArrow, dropdownPopupStyle = _c.popupStyle;
        var isExistChildren = children || children === 0;
        var _d = this.context, getPrefixCls = _d.getPrefixCls, zIndex = _d.zIndex;
        var _e = this.state, popupVisible = _e.popupVisible, popupStyle = _e.popupStyle;
        if (!popup) {
            return null;
        }
        var mergeProps = {};
        ...
        var popupClassName = (0, classNames_1.default)(prefixCls, childrenPrefix, prefixCls + "-position-" + position, className);
        ...
        var portalContent = (react_1.default.createElement(react_transition_group_1.CSSTransition, { in: !!popupVisible, timeout: duration, classNames: classNames, unmountOnExit: unmountOnExit, appear: true, mountOnEnter: true, onEnter: function (e) {
            ...
            react_1.default.createElement(resizeObserver_1.default, { onResize: this.onResize },
                react_1.default.createElement("span", __assign({ ref: function (node) { return (_this.triggerRef = node); }, "trigger-placement": this.realPosition, style: __assign(__assign(__assign({}, popupStyle), { position: 'absolute', zIndex: zIndex || '' }), style) }, popupEventProps, { className: popupClassName }),
                    ...
                    (showArrow || arrowProps) && (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-arrow-container", (_a = {},
                            _a[childrenPrefix + "-arrow-container"] = childrenPrefix,
                            _a)) },
                        react_1.default.createElement("div", __assign({}, arrowProps, { className: (0, classNames_1.default)(prefixCls + "-arrow", (_b = {},
