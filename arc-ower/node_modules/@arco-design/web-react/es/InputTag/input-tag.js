...
function InputTag(baseProps, ref) {
    ...
    var UsedTransitionGroup = useMemo(function () { return function (_a) {
    ...
    var clearIcon = allowClear && !disabled && value.length ? (React.createElement(IconHover, { size: size, key: "clearIcon", className: prefixCls + "-clear-icon", onClick: function (e) {
            e.stopPropagation();
            valueChangeHandler([]);
            if (!focused) {
    ...
    return (React.createElement("div", __assign({}, pickTriggerPropsFromRest(props), { style: style, className: cs(prefixCls, (_a = {},
        ...
        React.createElement("div", { className: prefixCls + "-view" },
            React.createElement(UsedTransitionGroup, null,
                ...
                React.createElement(CSSTransition, { key: "input", timeout: CSS_TRANSITION_DURATION, classNames: "zoomIn" },
                    React.createElement(InputComponent, { size: size, disabled: disabled || disableInput, readOnly: readOnly, ref: inputRef, autoFocus: autoFocus, placeholder: !value.length ? placeholder : '', prefixCls: prefixCls + "-input", autoFitWidth: {
