...
exports.compareVersion = exports.isValidComponent = void 0;
const componentList = [
    'common',
    'Common',
    'Alert',
...
const compareVersion = (v1, v2) => {
    ...
    // Beta part
    const subArray1 = ((_a = mainArray1[1]) !== null && _a !== void 0 ? _a : '').split('.');
    const subArray2 = ((_b = mainArray2[1]) !== null && _b !== void 0 ? _b : '').split('.');
