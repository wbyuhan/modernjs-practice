...
var ListPanel = function (props) {
    var _a = __read((0, useRefs_1.default)(), 2), activeOptionList = _a[0], setActiveOptionList = _a[1];
    ...
    var onMultipleChecked = function (option, checked) {
        ...
        newValue.sort(function (a, b) {
            var aIndex = props.value.findIndex(function (item) { return (0, isEqualWith_1.default)(item, a); });
            var bIndex = props.value.findIndex(function (item) { return (0, isEqualWith_1.default)(item, b); });
            if (aIndex === -1) {
                return 1;
            }
            if (bIndex === -1) {
        ...
        if (props.popupVisible && options.length) {
            var scrollTo_1 = function () {
                activeOptionList.forEach(function (activeOption, i) {
                    activeOption &&
                        (0, scroll_into_view_if_needed_1.default)(activeOption, {
                            block: 'nearest',
    ...
    return (react_1.default.createElement(react_transition_group_1.TransitionGroup, { component: react_1.default.Fragment }, menus.map(function (list, level) {
        var _a, _b;
        ...
        return list.length === 0 && !showEmptyChildren ? null : (react_1.default.createElement(react_transition_group_1.CSSTransition, { key: level, timeout: {
            ...
            react_1.default.createElement("div", { className: prefixCls + "-list-column", style: { zIndex: menus.length - level } }, dropdownColumnRender(react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-list-wrapper", (_a = {},
                    _a[prefixCls + "-list-wrapper-with-footer"] = footer !== null,
                    _a)) },
                list.length === 0 ? (renderEmpty && renderEmpty(120)) : (react_1.default.createElement("ul", { ref: function (node) { return setRefWrapper(node, level); }, className: (0, classNames_1.default)(prefixCls + "-list", prefixCls + "-list-select", (_b = {},
                    ...
                    return (react_1.default.createElement("li", { key: option.value, className: (0, classNames_1.default)(prefixCls + "-list-item", (_a = {},
                        ...
                        react_1.default.createElement(option_1.default, { prefixCls: prefixCls, multiple: multiple, option: option, 
                            // 叶子节点被选中
                            selected: !multiple &&
                                option.isLeaf &&
