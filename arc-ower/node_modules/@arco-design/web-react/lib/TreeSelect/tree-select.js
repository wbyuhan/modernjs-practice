...
var TreeSelect = function (baseProps, ref) {
    ...
    var triggerChange = (0, react_1.useCallback)(function (newValue) {
        setValue(newValue);
        resetInputValue();
        if (!multiple) {
    ...
    var handleRemoveCheckedItem = function (item, index, e) {
        ...
        var result = (0, util_1.getAllCheckedKeysByCheck)(item.value, false, (0, utils_1.normalizeValueToArray)(value), key2nodeProps, indeterminateKeys.current);
    ...
    var searchKeys = (0, react_1.useMemo)(function () {
        var newKeys = new Set(hitKeys);
        if (inputValue) {
            for (var key in key2nodeProps) {
                var item = key2nodeProps[key];
                if (newKeys.has(key)) {
                    item.pathParentKeys.forEach(function (_key) { return newKeys.add(_key); });
                }
    ...
    return (react_1.default.createElement(Trigger_1.default, __assign({ autoAlignPopupWidth: false, autoAlignPopupMinWidth: true, ref: triggerRef, classNames: "slideDynamicOrigin", trigger: "click", position: "bl", getPopupContainer: props.getPopupContainer, popupAlign: { bottom: 4 }, unmountOnExit: props.unmountOnExit }, props.triggerProps, { className: (0, classNames_1.default)(prefixCls + "-trigger", props.triggerProps && props.triggerProps.className), popup: function () {
            ...
            return (react_1.default.createElement("div", { className: prefixCls + "-popup", onMouseDown: function (e) {
                    e.preventDefault();
                }, style: __assign({ maxHeight: ((_a = props.treeProps) === null || _a === void 0 ? void 0 : _a.height) || ((_c = (_b = props.treeProps) === null || _b === void 0 ? void 0 : _b.virtualListProps) === null || _c === void 0 ? void 0 : _c.height) ? 'unset' : '' }, props.dropdownMenuStyle) }, (0, is_1.isFunction)(dropdownRender) ? dropdownRender(dom) : dom));
        }, disabled: props.disabled, onVisibleChange: function (visible) {
            setPopupVisible(visible);
            props.onVisibleChange && props.onVisibleChange(visible);
        }, popupVisible: popupVisible }), props.triggerElement || (react_1.default.createElement(select_view_1.default, __assign({ ref: refSelectView }, props, { popupVisible: popupVisible, value: !multiple && (0, is_1.isArray)(value) ? value[0] : value, inputValue: inputValue, 
        // other
