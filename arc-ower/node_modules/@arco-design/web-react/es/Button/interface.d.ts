...
export declare type AnchorButtonProps = {
    ...
    target?: string;
    anchorProps?: HTMLProps<HTMLAnchorElement>;
} & BaseButtonProps & Omit<React.AnchorHTMLAttributes<any>, 'type' | 'onClick' | 'className'>;
export declare type FinalButtonProps = {
    htmlType?: 'button' | 'submit' | 'reset';
} & BaseButtonProps & Omit<React.ButtonHTMLAttributes<any>, 'type' | 'onClick' | 'className'>;
/**
 * @title Button
 */
export declare type ButtonProps = Partial<FinalButtonProps & AnchorButtonProps>;
