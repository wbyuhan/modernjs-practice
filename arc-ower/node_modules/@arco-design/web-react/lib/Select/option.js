...
function Option(props, ref) {
    ...
    var isChecked = isMultipleMode
        ...
        : valueSelect === value;
    var optionProps = __assign({ ref: ref, style: style, className: (0, classNames_1.default)(prefixCls + "-option", (_a = {},
    ...
    if (isMultipleMode) {
        return (react_1.default.createElement("li", { className: (0, classNames_1.default)(prefixCls + "-option-wrapper", (_b = {},
                _b[prefixCls + "-option-wrapper-selected"] = isChecked,
                _b[prefixCls + "-option-wrapper-disabled"] = disabled,
                _b), wrapperClassName) },
            react_1.default.createElement(Checkbox_1.default, { className: prefixCls + "-checkbox", checked: isChecked, disabled: disabled, onChange: optionProps.onClick }),
            react_1.default.createElement("span", __assign({}, optionProps), children)));
    }
    return react_1.default.createElement("li", __assign({}, optionProps), children);
}
var OptionComponent = react_1.default.forwardRef(Option);
